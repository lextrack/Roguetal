...
func setup_mobile_controls() -> void:
	mobile_controls = preload("res://UI/ui_scenes/mobile_controls.tscn").instantiate()
	add_child(mobile_controls)
	
	mobile_controls.connect("movement_vector_changed", Callable(self, "_on_movement_vector_changed"))
	mobile_controls.connect("aim_vector_changed", Callable(self, "_on_aim_vector_changed"))
	mobile_controls.connect("shooting_started", Callable(self, "_on_shooting_started"))
	mobile_controls.connect("shooting_ended", Callable(self, "_on_shooting_ended"))
	mobile_controls.connect("weapon_switch_pressed", Callable(self, "_on_weapon_switch_pressed"))
	mobile_controls.connect("pause_button_pressed", Callable(self, "_on_pause_button_pressed"))
	mobile_controls.connect("stats_button_pressed", Callable(self, "_on_stats_button_pressed"))
...
func display_HUD_while_using_directionalight():
	...
	if stored_stats_window:
		canvas_layer.add_child(stored_stats_window)
